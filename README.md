...
A Streamlit web app that compares a team's actual starting batting order against sabermetric-optimized lineups, built around OBP, wRC+, and a handedness-aware hybrid lineup.
...
The stats come from the MLB StatsAPI and are intended as a fun, analytics-driven exercise. Lineup optimization is one way to think about building a batting order — but at the end of the day, **baseball is played on the field, not on a computer**. Go watch your local baseball game!
